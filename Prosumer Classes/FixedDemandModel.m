classdef FixedDemandModel < Component
    
    % FixedDemandModel Static MLD system model to allow input of known
    ...
    methods
        ...
        function self = FixedDemandModel(name,N)
        ...
        function C = get_C(self)
            C = self.C;
            %construct constraints for FixedDemandModel
